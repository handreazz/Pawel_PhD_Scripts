...
#======================================================================#
#                                                                      #
# Analyze output of find_residue_contacts.py. A file is saved for each #
...
directory="/net/casegroup2/u2/pjanowsk/Case/4lzt/4lzt_ff12SB/analysis_i/contacts/residContact/"
# contacts with the following residues will be ignored
