...
What could be done (better because not fitting to each uc separately which avoids skipping
waters in boundaries or having to add the buffer):
...
if __name__ == "__main__" :
  parm_file_name = '4lztSi.prmtop'
  traj_file_name = '../../fit_wat.nc'
  asu_rst7_file_name = 'asu_4lzt.rst7'
  asu_prmtop_file_name = 'asu_4lzt.prmtop'
  prop_a = 3
  prop_b = 2
  prop_c = 2
  target_unit_cell = 1
...
#       spacegroup)
  ...
  atsel=[]
  for target_unit_cell in range(1,13):
    print "UNIT CELL %d" %target_unit_cell
