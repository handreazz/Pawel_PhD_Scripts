...
parser.add_argument("-ref", "--reference", help="Supercell restart file with correct box info on last line")
#parser.add_argument("-t", "--Trajectory", help="Supercell Trajectory")
parser.add_argument("-rst", "--targetRST", help="Restart file with box info on last line")
args = parser.parse_args()



#GET CRYSTAL VOLUME
reffile=rst7(args.reference)
refBox=reffile.Get_Box()
refVol=Get_volume(refBox)
#print refVol
#GET TARGET VOLUME
tfile=rst7(args.targetRST)
tBox=tfile.Get_Box()
tVol=Get_volume(tBox)
#print tVol
print "Volume(%%): %7.3f" %(tVol/refVol*100)
