...
#Don't forget to modify the number of frames for the percent calculation (line 25)


states=genfromtxt('../ChannelWater/waterdistribution')

states=states[100000:120000,:]
f=open('avgwaterpercell_2000_2400','w')
for i in range(1,37):
	if i%3==1: 
		j=i+2
	elif i%3==0 or i%3==2:
